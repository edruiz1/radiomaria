...
/**
 * @file
 * Contains \Drupal\rmaria_aux\Plugin\Field\FieldFormatter\ImageRawFormatter.
 */

// http://enzolutions.com/articles/2014/12/09/how-to-create-a-field-formatter-in-drupal-8/

namespace Drupal\rmaria_aux\Plugin\Field\FieldFormatter;
    ...
    foreach ($items as $delta => $item) {
      if ($item->entity) {
        ...
        $elements[$delta] = array(
          '#markup' =>  '<img src="'. $image_uri . '" />',
          '#attributes' => [
            'formatter' => ['image_raw_formatter']
          ]
        );
      }
    }
